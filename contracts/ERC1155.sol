...
contract ERC1155 is IERC1155, IERC1155MetadataURI {
    ...
    function total_supply(uint256 token_id) public view returns(uint256) {
      return total_supplies[token_id];
    }
    /**
    ...
    function _burn(
        ...
        uint256 fromBalance = _balances[id][from];
        uint256 totalSupply = total_supplies[id];
        require(fromBalance >= amount, "ERC1155: burn amount exceeds balance");
        unchecked {
            _balances[id][from] = fromBalance - amount;

            total_supplies[id] = totalSupply - amount;
        }
